...
const CreateContainer = () => {
  ...
  const [msg, setMsg] = useState("Muhammad Zubair");
    ...
    <>
          <div className="py-5 md:py-10">
                  ...
                  <>
                    <motion.p
                      ...
                      className={`text-white text-center p-1 rounded ${
                        danger === "success" ? "bg-green-500" : "bg-green-500"
                      }`}
                    >
                      {msg}
                    </motion.p>
                  ...
                  {product.productImage ? (
                    <>
                      ...
                      <button
                        ...
                        className="absolute bottom-0 right-0 box-border text-white p-1 rounded-t-full rounded-l-full cursor-pointer text-xl bg-green-600"
                      >
                        <MdOutlineDelete />
                      </button>
                    </>
            ...
            <div className="my-7 p-2 md:p-4">
              <h1 className="capitalize text-lg md:text-2xl  font-semibold before:rounded-lg relative before:absolute before:-bottom-2 before:content before:left-0 before:w-32 before:h-1 before:bg-green-500 transition-all ease-in-out duration-100">
                Recent Upload
              </h1>
              <div className="flex ">
                <RecentUpload />
