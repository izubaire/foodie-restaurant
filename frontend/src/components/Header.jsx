        ...
        {user.email && (
          <div className="flex items-center text-green-600 text-base">
            ...
            {process.env.REACT_APP_ADMIN_ID === user.email && (
              <p className="text-sm text-white bg-green-600 px-3 rounded-full">
                Admin
              </p>
            )}
          </div>
        ...
        <div className="flex items-center gap-8 ">
          ...
          >
            <NavLink
              ...
              onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
              className={({ isActive }) =>
                `text-base  text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer box-border h-full flex items-center hover:border-b-4 hover:border-green-600 hover:font-semibold p-1  ${
                  isActive ? "border-b-4 border-green-600 font-semibold" : ""
                } `
              }
              end
            >
          ...
          >
            ...
            >
              ...
              <div className="absolute top-0 -right-2 w-4 h-4  rounded-full bg-green-600 -translate-y-1/3 text-center">
              ...
              >
                ...
                <div className="rounded overflow-hidden">
                  {process.env.REACT_APP_ADMIN_ID === user.email && (
                    <Link
                      ...
                      className="whitespace-nowrap flex hover:bg-green-50 hover:text-slate-600 py-1 px-2 items-center w-full gap-3"
                    >
                      New Item
                ...
                <div className="rounded overflow-hidden">
                  <Link
                    ...
                    to={"./"}
                    className="whitespace-nowrap flex hover:bg-green-50 hover:text-green-600 py-1 px-2 items-center w-full gap-3"
                  >
                    Logout
      ...
      <div className="flex md:hidden w-full  h-full items-center justify-between">
        ...
        {user.email && (
          <div className="flex items-center text-green-600 text-sm">
            ...
            {process.env.REACT_APP_ADMIN_ID === user.email && (
              <p className="text-xs text-white bg-green-600 px-2 mx-2 rounded-full">
                Admin
              </p>
            )}
          </div>
          ...
          {isLogin && (
            ...
            >
              ...
              <div className="w-full">
                <ul className="flex flex-col  h-full  ">
                  <NavLink
                    to="/"
                    onClick={() => setIsLogin(false)}
                    className="text-base  whitespace-nowrap flex hover:bg-green-50 hover:text-slate-600 py-2 rounded hover:font-semibold px-3 items-center w-full gap-3 "
                  >
                    Home
                  </NavLink>
                  <NavLink
              ...
              <div className="rounded overflow-hidden">
                {process.env.REACT_APP_ADMIN_ID === user.email && (
                  <Link
                    to={"./createitem"}
                    onClick={() => setIsLogin(false)}
                    className="whitespace-nowrap flex hover:bg-green-50 hover:text-slate-600 py-2 px-3 items-center w-full gap-3 hover:font-semibold"
                  >
                    New Item
                    <MdAddCircleOutline className="ml-auto " />
                  </Link>
              ...
              <div className="rounded overflow-hidden">
                <div
                  onClick={handleLogout}
                  className="whitespace-nowrap flex bg-green-600 text-white hover:bg-green-500 py-1 px-3 items-center w-full gap-3"
                >
